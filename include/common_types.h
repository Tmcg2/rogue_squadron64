...
// Use this to indicate that the type of a pointer is unknown,
// but can be left as void for the purposes of matching
// Ideally, this will be removed one the game has been fully
// matched.
#define UNIDENTIFIED_TYPE void
